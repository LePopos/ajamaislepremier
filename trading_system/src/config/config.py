...
class Config(BaseSettings):
    ...
    watchlist: List[str] = ["NVDA","PLTR","CYBR","NIO","AMD","APP","ARM","RDDT","TSEM","GOOGL","SOUN","MARA","FTNT","MU","INTC","GLW","AZTA","TSM"]  # Portfolio réel + expert picks
    current_holdings: List[str] = ["NVDA","PLTR","CYBR","NIO","AMD","APP","ARM","RDDT","TSEM","GOOGL","SOUN","MARA","FTNT"]  # Actions actuellement détenues
